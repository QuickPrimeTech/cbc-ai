...
export const HeroSection = () => {
  return (
    <section className="relative max-w-7xl mt-16 mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      <div className="relative z-10">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
          ...
          fully aligned with the Kenya Institute of Curriculum Development
          (KICD) Competency-Based Curriculum (CBC). Trusted by 10,000+ Kenyan
          teachers.
        </p>
